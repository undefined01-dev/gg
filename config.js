module.exports = {
  bot: {
    owners: ["840697479905542194","1153316197081821286","881213898416590888"],  // اونر
    botID: "1002713312661872731",    // ايدي البوت
    GuildId: "1159943649187086428",   // ايدي السيرفير
    ...
    callbackURL: "http://neko.pylex.xyz:10641", // الكال باك
    TheLinkVerfy : "https://discord.com/oauth2/authorize?client_id=1002713312661872731&response_type=code&redirect_uri=http%3A%2F%2Fneko.pylex.xyz%3A10641&scope=guilds.join+guilds+email+identify", // رابط اوثو رايز بالصلاحيه ادخال الي سيرفرات
    prefix : '$', 
    ...
    done : "1281386772923682878",//ايدي روم تمت العملية
    ...
    fedroom : "1281386772923682878",//ايدي روم الفيدباك
    clientrole : "1299803548929757295"//ايدي رتبه الزباين
  },
  website: {
    PORT: "10641",
  }
